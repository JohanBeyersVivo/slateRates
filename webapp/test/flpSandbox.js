					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Slate Rates Adjustment",
									"targetURL": "#slaterates-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"slaterates-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=slaterates",
									"url": sap.ui.require.toUrl("slaterates")
								}
							}
						}
					}
